 ...
 */
package eu.fusepool.enhancers.marec.web.resource;
 ...
 */
@Path("/marec")
public class MarecSPARQLRootResource extends BaseStanbolResource {
    ...
    public MarecSPARQLRootResource(@Context ServletContext servletContext) {
     ...
     * <b>application/rdf+xml</b> format, otherwise in <b>application/sparql-results+xml</b> format.
     * 
     * @param graphUri
    ...
    private List<TripleCollectionInfo> tripleCollections = new ArrayList<MarecSPARQLRootResource.TripleCollectionInfo>();
